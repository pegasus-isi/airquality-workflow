...
echo ""
echo "# Standard forecast container (with PyTorch)"
echo "  cd Docker"
echo "  docker build -f AirQuality_Forecast_Dockerfile -t kthare10/airquality-forecast:latest ."
echo "  docker push kthare10/airquality-forecast:latest"
echo ""
echo "# DPU edge container (lightweight, no PyTorch)"
echo "  docker build -f AirQuality_Forecast_DPU_Dockerfile -t kthare10/airquality-forecast-dpu:latest ."
echo "  docker push kthare10/airquality-forecast-dpu:latest"
echo ""
